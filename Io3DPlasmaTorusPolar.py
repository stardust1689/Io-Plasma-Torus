...
# fig.suptitle("3D Model of Io's Plasma Torus\n(from north side, O 2+)", fontsize=14)
...
ax.set_ylim([-7,7])
ax.set_zlim([-7,7])
ax.set_title("3D Model of Io's Plasma Torus\n(from north side, S 3+)", color='aqua', fontsize=15, y = 0.96)
...
# y = and number from 0000 to 0200 (MUST include zeros)
file1 = open('./data/plots/data/s3p/DENS/DENSs3p0045_3D.dat')
file2 = open('./data/plots/data/s3p/TEMP/TEMPs3p0045_3D.dat')
